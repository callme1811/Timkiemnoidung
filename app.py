...
# API key và model (lấy từ biến môi trường hoặc hardcode)
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "YOUR_API_KEY_HERE")
MODEL_NAME = os.environ.get("GEMINI_MODEL", "gemini-2.5-flash")

if not GEMINI_API_KEY:
    st.error("Chưa cấu hình GEMINI_API_KEY trong biến môi trường hoặc code.")
    st.stop()
...
# ====================== Streamlit UI ======================
st.title(APP_TITLE)
st.caption("📄 Làm nét ECG & phân tích tài liệu với Gemini AI")

uploaded_files = st.file_uploader("Upload ảnh hoặc PDF ECG", type=["png","jpg","jpeg","pdf"], accept_multiple_files=True)
    ...
    if question:
        ...
        with st.spinner("Đang đọc tài liệu..."):
            ...
            if not all_nodes:
                ...
                st.stop()
            selected_nodes = select_relevant_nodes(question, all_nodes)
